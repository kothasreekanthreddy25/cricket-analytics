                ...
                <ShareButtons
                  ...
                  text={
                    analysis.winProbabilityA >= analysis.winProbabilityB
                      ? `${analysis.teamA} vs ${analysis.teamB} — AI predicts ${analysis.teamA} to win (${Math.round(analysis.winProbabilityA)}%)`
                      : `${analysis.teamA} vs ${analysis.teamB} — AI predicts ${analysis.teamB} to win (${Math.round(analysis.winProbabilityB)}%)`
                  }
                />
              </div>
